...
function attachAdmin(app) {
  ...
  const seed = {
    business_name: 'Talent Inspirations',
...
const ADMIN_HTML = `<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Talent Inspirations Admin Dashboard</title><style>
